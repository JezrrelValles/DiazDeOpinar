...
const Footer = () => {
  return (
    <footer className="h-16 w-full bg-safety-orange flex justify-center items-center fixed bottom-0">
      <div className="flex space-x-8 sm:space-x-12 md:space-x-16 lg:space-x-24">
        <a href="https://www.facebook.com/HectorDiazBaylon" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
        ...
        <a href="https://x.com/DiazBaylon" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
